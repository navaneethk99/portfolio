            ...
            <div className="border h-fit rounded-md border-gray-600 text-white">
              ...
              <div className="min-h-40 ">
                ...
                <div className="p-4 text-sm mt-2 techno-font-body">
                  Satellite Monitoring Dashboard is a web application designed
                  to provide powerful visualization and analysis of data
                  collected from an advanced satellite monitoring system. It
                  simplifies the process of working with complex datasets by
                  combining intuitive design, interactive features, and
                  real-time insights. <br /> <br />
                  One of the core features of the dashboard is audio call
                  transcription from major satellite communication networks,
                  including Thuraya, Iridium, and ISAT satellite phones. This
                  allows users to seamlessly convert voice data into searchable
                  text, making information retrieval and analysis much more
                  efficient. <br /> <br />
                  To further enhance usability, the platform includes
                  interactive graphs and charts, enabling users to quickly spot
                  trends, patterns, and anomalies in satellite data. These
                  visualizations turn raw data into actionable insights, helping
                  operators make informed decisions with confidence.
                  <br />
                  <ol className="list-decimal list-inside mt-2">
                    <li className="mt-5">
                      React.js provides a fast, component-driven frontend
                      framework for building a responsive and interactive user
                      interface.
                    </li>
                    <li className="mt-5">
                      ReCharts, a charting library for React, powers the
                      interactive visualizations, allowing users to engage with
                      data dynamically and intuitively.
                    </li>
                  </ol>
                  <br />
                  With its blend of advanced satellite integration,
                  transcription capabilities, and rich visual analytics, the
                  Satellite Monitoring Dashboard is a robust solution for
                  turning raw satellite communications into meaningful,
